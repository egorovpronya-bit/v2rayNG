...
object AppConfig {
    ...
    const val PREF_AUTO_SELECT = "pref_auto_select"
    const val PREF_RUSSIAN_BYPASS_INITIALIZED = "pref_russian_bypass_initialized"
    const val PREF_RUSSIAN_BYPASS_VERSION = "pref_russian_bypass_version"
    ...
    const val PREF_BATTERY_OPT_REQUESTED = "pref_battery_opt_requested"
    ...
    const val APP_URL = "https://nl2.saqanet.ru"
    const val APP_API_URL = "https://api.github.com/repos/egorovpronya-bit/v2rayNG/releases"
    const val APP_ISSUES_URL = "https://t.me/SAQANet_bot"
    const val APP_WIKI_MODE = "https://saqanet.ru"
    const val APP_PRIVACY_POLICY = "https://saqanet.ru/privacy"
    const val APP_PROMOTION_URL = ""
    const val TG_CHANNEL_URL = "https://t.me/SAQANet_bot"
